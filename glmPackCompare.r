...
# Source: http://stackoverflow.com/questions/19532651/benchmarking-logistic-regression-using-glm-fit-bigglm-speedglm-glmnet-libli

glmPackCompare <- function(N, p, chunk=NULL, Ifsample=FALSE, size=NULL, reps=5)
{
  # simulate dataset:
